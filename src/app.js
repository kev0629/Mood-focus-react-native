...
const REACTIONS = [
  { label: "Très content", src: require('./assets/Verry_Happy_grey.png'), bigSrc: require('./assets/Verry_Happy.png') },
  { label: "Content", src: require('./assets/Happy_grey.png'), bigSrc: require('./assets/Happy.png') },
  { label: "Cool", src: require('./assets/cool_grey.png'), bigSrc: require('./assets/cool.png') },
  { label: "Triste", src: require('./assets/sad_grey.png'), bigSrc: require('./assets/sad.png') },
  { label: "Pas content", src: require('./assets/hangry_grey.png'), bigSrc: require('./assets/hangry.png') },
];
const WIDTH = 800;
